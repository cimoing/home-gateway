...
type BTTask struct {
	...
	SyncStrategy   string     `db:"sync_strategy" json:"-"`
	SyncStatus     string     `db:"sync_status" json:"-"`
	SyncError      string     `db:"sync_error" json:"-"`
...
type BTTaskFile struct {
	...
	SyncStatus     string `db:"sync_status" json:"-"`
	SyncError      string `db:"sync_error" json:"-"`
	SyncedBytes    int64  `db:"synced_bytes" json:"-"`
	CompletedBytes int64  `db:"-" json:"completedBytes"`
}
